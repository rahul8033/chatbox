...
import { AiFillGift, BiMessageAltEdit, BsPlusCircle, RiGalleryLine,AiFillLike,IoSend } from 'react-icons/all'
            ...
            </div>
            {
                newMessage ?
                    <div onClick={sendMessage} className="file sentOrLike">
                        <label className='sentOrLikeO'> <IoSend/> </label>

                    </div> : <div onClick={sendMessage} className="file sentOrLike">
                        <label className='sentOrLiket'> <AiFillLike/> </label>
